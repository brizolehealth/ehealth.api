defmodule GraphQLWeb.LegalEntityDeactivationJobResolverTest do
  ...
  @legal_entity_deactivation_type Core.Jobs.type(:legal_entity_deactivation)
  ...
  defp create_job(legal_entity_id) do
    {:ok, job} = Jobs.create(%{"legal_entity_id" => legal_entity_id}, @legal_entity_deactivation_type)
